            ...
            <div className="flex items-start justify-center flex-col gap-4">
                {
                    firestoreStory.length < 1
                        ...
                        <>
                            ...
                            <Link href={`/story-tag/`} className='border-[var(--cinza)] bg-[#ECECEC] border-[1px] p-1 px-6 rounded-2xl text-[var(--verde)] text-sm hover:scale-[1.01] duration-200'>Menu</Link>
